...
const relationsData = {
    ...
    "plano-b": {
        ...
        bullets: [
            "<strong>Variantes de Propósito:</strong> Se abre en 4 variantes de flujo según el objetivo de la PyME (Marketplace visible, Líneas Preaprobadas, Diagnóstico con roadmap o descarga de Informe IA).",
            ...
            "<strong>Marca Blanca:</strong> Embebible como widget o API en bancos, SGRs o cámaras empresarias asociadas para distribuir la plataforma."
        ],
        techDetails: {
    ...
    1: {
        ...
        "step-8": {
            ...
            query: {
                ...
                response: "Las SGRs, bancos y fondos adheridos buscan en el marketplace mediante filtros de **score, sector y región**. Al encontrar a la metalúrgica, acceden a su legajo estructurado y pueden preaprobar avales o créditos sin contacto previo, reduciendo la fricción a cero.",
                activeCapas: ["capa-3", "capa-6", "capa-predictiva-loop"],
                activeMon: "mon-6"
            }
        }
    ...
    3: {
        "step-6": {
            ...
            query: {
                ...
                response: "El diagnóstico analiza la calidad e integridad de la información cargada. Metalúrgica del Plata S.A. tiene actualmente un **65% de completitud** en su carpeta. El sistema evalúa qué datos clave faltan subir y cuánto sumarían al score QUANT de elegibilidad de crédito.",
...
chatForm.addEventListener('submit', (e) => {
    ...
    if (textLower.includes('afip') || textLower.includes('deuda') || textLower.includes('cheque') || textLower.includes('rechazado') || textLower.includes('bcra') || textLower.includes('solvencia')) {
        ...
        responseText = "Hola. Como Asistente IA de este CUIT puedo resolver tus dudas sobre el dataset de <strong>Metalúrgica del Plata S.A.</strong>. Pregúntame sobre: <br>1. *Deudas previsionales AFIP o situación crediticia* (Capa 1/2)<br>2. *Juicios y demandas activas* (Capa 5 IA)<br>3. *Riesgo e impacto de venderle a 60 días* (Capa 4 Predicción)<br>4. *Límites recomendados y monitoreo* (Capa 3/6)<br>5. *Huella P-L-R y trayectoria predictiva* (Bucle Predictivo)";
        ...
        <div class="plr-widget-container">
            <div class="plr-header">
                <div class="plr-company-info">
                    ...
                    <span class="plr-company-sector">${companyData.sector}</span>
                </div>
...
function renderRoadmapChecklist(containerId) {
    ...
    container.innerHTML = `
        <div class="roadmap-checklist-container">
            <div class="roadmap-header">
                <span class="roadmap-title">Legajo Financiero — Metalúrgica del Plata</span>
    ...
    if (btnBalance) {
        btnBalance.addEventListener("click", (e) => {
            ...
            appendChatMessage("MatchFin Assistant", "Se ha cargado con éxito el Balance 2025 de **Metalúrgica del Plata S.A.** El score de completitud del legajo sube a " + (65 + (balanceChecked ? 20 : 0) + (afipChecked ? 15 : 0)) + "%. Tu carpeta es ahora un +12% más elegible para las SGRs.", "ai-msg");
        });
    }
    ...
    if (btnAfip) {
        btnAfip.addEventListener("click", (e) => {
            ...
            afipChecked = true;
            renderRoadmapChecklist(containerId);
            appendChatMessage("MatchFin Assistant", "Clave Fiscal conectada con éxito. Importación de facturas de IVA del CUIT 30-74891253-9 finalizada. El score de completitud sube a " + (65 + (balanceChecked ? 20 : 0) + (afipChecked ? 15 : 0)) + "%.", "ai-msg");
        });
    }
}
